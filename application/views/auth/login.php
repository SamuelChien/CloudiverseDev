            ...
            <section id="login-window">
                ...
                <div data-section="" class="section-container auto font-title" style="min-height: 51px;" data-section-resized="true">
                    <section class="dropdown active">
                        <div data-section-title="" class="title"><a href="#panel1"><span class="font-awesome mobile-tab-icon hide-for-medium-up"></span>Login</a></div>
                    ...
                    <section class="dropdown">
                        <div data-section-title="" class="title" style="left: 89px;"><a href="#panel2"><span class="font-awesome mobile-tab-icon hide-for-medium-up"></span>Sign Up</a></div>
                        <div data-section-content="" class="content">
                            <!--Registration form-->
                            ...
                            <div class="seperator"></div>
                            <p>Sign up using a social network</p>
                        </div>
                    </section>
                </div>
            </section>
