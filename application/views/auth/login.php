...
<?php
      ...
      <section id="login-window">
        <dl data-tab="" class="tabs">
          <dd class="active"><a href="#panel-1">Login</a></dd>
          <dd><a href="#panel-2">Sign Up</a></dd>
        </dl>
        <div class="tabs-content">
          <section id="panel-1" class="content active padding">
            <!--Login form-->
            <form method="post">
          ...
          <section id="panel-2" class="content padding">
            <!--Registration form-->
            <form method="post">
